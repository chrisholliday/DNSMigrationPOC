...
2. Validate legacy DNS resolution:
...
1. Deploy Private DNS + Resolver + private endpoints:
   - [scripts/02-deploy-private-dns.ps1](../scripts/02-deploy-private-dns.ps1)
...
1. Update Linux DNS forwarders to use the Resolver inbound endpoint:
   - [scripts/03-configure-legacy-forwarders.ps1](../scripts/03-configure-legacy-forwarders.ps1)
...
1. Switch Spoke1 VNet to Azure‑provided DNS:
   - [scripts/04-migrate-spoke1.ps1](../scripts/04-migrate-spoke1.ps1)
2. Validate:
...
1. Link Spoke2 to Private DNS and switch it to Azure‑provided DNS:
   - [scripts/05-migrate-spoke2.ps1](../scripts/05-migrate-spoke2.ps1)
2. Validate:
